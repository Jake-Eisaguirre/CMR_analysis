...
librarian::shelf(tidyverse, RPostgres, DBI, unmarked, here, lubridate, kableExtra, GGally, MuMIn)
...
pred_data <- data.frame(air_temp = seq(-1, 1, , 10))

predict(best_bf3, type = "det", newdata = pred_data, append = T)
