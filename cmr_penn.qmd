...
crPiFun <- function(p) {
    ...
    p6 <- p[,6]
    p7 <- p[,7]
    cbind("0010000" = (1-p1) * (1-p2) * p3 * (1-p4) * (1-p5) * (1-p6)* (1-p7),    #1: 0010000    
          "0110000" = (1-p1) * p2 * p3 * (1-p4) * (1-p5) * (1-p6)* (1-p7),        #2: 0110000
          "0100000" = (1-p1) * p2 * (1-p3) * (1-p4) * (1-p5) * (1-p6)* (1-p7),    #3: 0100000
          "0110010" = (1-p1) * p2 * p3 * (1-p4) * (1-p5) * p6* (1-p7),            #4: 0110010
          "0010010" = (1-p1) * (1-p2) * p3 * (1-p4) * (1-p5) * p6 * (1-p7),       #5: 0010010
          "0001100" = (1-p1) * (1-p2) * (1-p3) * p4 * p5 * (1-p6) * (1-p7),       #6: 0001100
          "0001000" = (1-p1) * (1-p2) * (1-p3) * p4 * (1-p5) * (1-p6)* (1-p7),    #7: 0001000
          "0001010" = (1-p1) * (1-p2) * (1-p3) * p4 * (1-p5) * p6 * (1-p7),       #8: 0001010
          "0100010" = (1-p1) * p2 * (1-p3) * (1-p4) * (1-p5) * p6 * (1-p7),       #9: 0100010
          "1101010" = p1 * p2 * (1-p3) * p4 * (1-p5) * p6 * (1-p7),               #10: 1101010
          "1101100" = p1 * p2 * (1-p3) * p4 * p5 * (1-p6)* (1-p7),                #11: 1101100
          "0101100" = (1-p1) * p2 * (1-p3) * p4 * p5 * (1-p6)* (1-p7),            #12: 0101100
          "1001000" = p1 * (1-p2) * (1-p3) * p4 * (1-p5) * (1-p6) * (1-p7),       #13: 1001000
          "1101000" = p1 * p2 * (1-p3) * p4 * (1-p5) * (1-p6)* (1-p7),            #14: 1101000
          "0101000" = (1-p1) * p2 * (1-p3) * p4 * (1-p5) * (1-p6)* (1-p7),        #15: 0101000
          "0101001" = (1-p1) * p2 * (1-p3) * p4 * (1-p5) * (1-p6)* p7,            #16: 0101001
          "1001010" = p1 * (1-p2) * (1-p3) * p4 * (1-p5) * p6 * (1-p7),           #17: 1001010
          "1100000" = p1 * p2 * (1-p3) * (1-p4) * (1-p5) * (1-p6)* (1-p7),        #18: 1100000
          "1000000" = p1 * (1-p2) * (1-p3) * (1-p4) * (1-p5) * (1-p6) * (1-p7)    #19: 1000000
    )
}
